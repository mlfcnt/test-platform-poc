    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4">
        <div className="bg-white rounded-lg shadow-sm p-8">
          ...
          {/* Step content */}
          {step === 1 && (
            <Step1 config={config} setConfig={setConfig} onNext={handleNext} />
          )}
          {step === 2 && (
            <Step2
              config={config}
          ...
          {step === 4 && (
            <Step4 config={config} setConfig={setConfig} onBack={handleBack} />
          )}
        </div>
      </div>
    </div>
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600">
          Décrivez votre test en langage naturel. L&apos;IA s&apos;adaptera à
          vos besoins.
        </p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <textarea
            ...
            onChange={(e) =>
              setConfig({...config, gradingDescription: e.target.value})
            }
          />
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            onChange={(e) =>
              setConfig({...config, additionalRequirements: e.target.value})
            }
          />
        </div>
      </div>
...
function Step2({
  ...
  const [questionPlan, setQuestionPlan] = useState<QuestionPlan | undefined>(
    undefined
  );
  ...
  const regenerateQuestion = async (questionId: string, feedback: string) => {
    ...
    try {
      ...
      setQuestions(
        questions.map((q) => (q.id === questionId ? data.questions[0] : q))
      );
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-gray-900 mb-2">
          Plan de test et questions
        </h2>
        <p className="text-gray-600">
          L&apos;IA propose un plan structuré pour votre test. Ajoutez les
          questions qui vous conviennent.
        </p>
      </div>
      ...
      {!generated ? (
        <div className="text-center py-8">
          ...
          >
            {loading
              ? "Génération en cours..."
              : "Générer le plan et les questions"}
          </button>
        </div>
      ) : (
        <>
          ...
          {!showRegenerationForm ? (
            <div className="flex justify-between items-center mb-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
              <div>
                <p className="text-sm text-yellow-800">
                  Ce plan ne vous convient pas ? Vous pouvez en générer un
                  nouveau.
                </p>
              </div>
              <button
            ...
            <div className="mb-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
              <h4 className="font-medium text-yellow-800 mb-3">
                Que souhaitez-vous changer dans ce plan ?
              </h4>
              <textarea
                      ...
                      <div key={index} className="bg-white rounded-lg p-4">
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <span className="text-sm text-gray-600">
                            {category.suggestedCount} questions
                          </span>
                        </div>
          ...
          {showRegenerationForm && (
            <div className="mt-3 p-3 bg-orange-50 border border-orange-200 rounded-lg">
              <h5 className="text-sm font-medium text-orange-800 mb-2">
                Que voulez-vous changer dans cette question ?
              </h5>
              <textarea
                value={regenerationFeedback}
                onChange={(e) => setRegenerationFeedback(e.target.value)}
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600">
          Que voulez-vous montrer au candidat après qu&apos;il ait passé le test
          ?
        </p>
      </div>
      ...
      <div>
        ...
        <textarea
          ...
          onChange={(e) =>
            setConfig({...config, candidateResultsDescription: e.target.value})
          }
        />
      </div>
      ...
      <div className="space-y-6">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6">
            Votre test est maintenant prêt à être partagé
          </p>
        </div>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
          ...
          <p className="text-sm text-blue-700 mt-2">
            Partagez ce lien avec vos candidats pour qu&apos;ils puissent passer
            le test
          </p>
        </div>
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600">
          Quelles métriques voulez-vous suivre pour analyser les résultats ?
        </p>
      </div>
      ...
      <div>
        ...
        <textarea
          ...
          onChange={(e) =>
            setConfig({...config, adminDashboardDescription: e.target.value})
          }
        />
      </div>
      ...
      <div className="bg-green-50 border border-green-200 rounded-lg p-4">
        ...
        <ul className="text-sm text-green-700 space-y-1">
          <li>
            • <strong>Objectif:</strong> {config.objective}
          </li>
          <li>
            • <strong>Thème:</strong> {config.theme}
          </li>
          <li>
